$(document).ready(function() {
    kt.init();
    $.getJSON("json/layout.ru.json?3", //?" + Math.round(Math.random() * 100)
        function(data) {
...
var kt = {
    ...
    _pattern: "Шаблон текста и подсвеченный символ для тренировки слепого набора", //"Text for type and highlighted character",
    _typed: [],
    currentPosition: 0,
